...
def calcular_imc(peso, altura):
    """Calcula o IMC dado o peso (KG) e alutra (m)."""
...
try:
    #  Ler planilha e remover espaços extras nos nomes das colunas
    ...
    if not {'Nome', 'Peso', 'Altura'}.issubset(dados.columns):
        ...
        # Converteram para valores numéricos (evita erro com exto)
    ...
    #sobrescrever a planilha original mantendo os dados adicionando as colunas novas
